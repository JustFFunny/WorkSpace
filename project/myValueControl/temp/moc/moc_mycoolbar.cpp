...
**
** Created: Fri Aug 8 09:28:41 2014
...
static const char qt_meta_stringdata_myCoolBar[] = {
    "myCoolBar\0\0value\0valueChanged(int)\0"
};
...
const QMetaObjectExtraData myCoolBar::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject myCoolBar::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_myCoolBar,
      qt_meta_data_myCoolBar, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &myCoolBar::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_myCoolBar))

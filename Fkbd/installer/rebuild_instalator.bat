...
copy %QTDIR%\%QTVER%\bin\mingwm10.dll 
copy %QTDIR%\%QTVER%\bin\libgcc_s_dw2-1.dll
...
C:\MinGw\bin\strip "fkbd.exe" 

copy ..\bin\*.lnk

"C:\Program Files\NSIS\makensis.exe" fkbd.nsi

move /Y "fkbd_installl*" ..\

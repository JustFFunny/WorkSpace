...
**
** Created: Sat Aug 2 16:57:18 2014
...
static const char qt_meta_stringdata_ImageThread[] = {
    "ImageThread\0\0ImageFinished()\0"
};
...
void ImageThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        ImageThread *_t = static_cast<ImageThread *>(_o);
        switch (_id) {
        case 0: _t->ImageFinished(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
...
const QMetaObjectExtraData ImageThread::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject ImageThread::staticMetaObject = {
    { &QThread::staticMetaObject, qt_meta_stringdata_ImageThread,
      qt_meta_data_ImageThread, &staticMetaObjectExtraData }
};
...
// SIGNAL 0
void ImageThread::ImageFinished()
{

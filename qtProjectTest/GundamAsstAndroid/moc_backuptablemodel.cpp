...
**
** Created: Sat Aug 2 16:56:50 2014
...
static const char qt_meta_stringdata_BackupTableModel[] = {
    "BackupTableModel\0"
};
...
const QMetaObjectExtraData BackupTableModel::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject BackupTableModel::staticMetaObject = {
    { &QAbstractTableModel::staticMetaObject, qt_meta_stringdata_BackupTableModel,
      qt_meta_data_BackupTableModel, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &BackupTableModel::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_BackupTableModel))
...
static const char qt_meta_stringdata_BackupSortModel[] = {
    "BackupSortModel\0"
};
...
const QMetaObjectExtraData BackupSortModel::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject BackupSortModel::staticMetaObject = {
    { &QSortFilterProxyModel::staticMetaObject, qt_meta_stringdata_BackupSortModel,
      qt_meta_data_BackupSortModel, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &BackupSortModel::getStaticMetaObject() { return staticMetaObject; }
#endif //Q_NO_DATA_RELOCATION
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_BackupSortModel))
